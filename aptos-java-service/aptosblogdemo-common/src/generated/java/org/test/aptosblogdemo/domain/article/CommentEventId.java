...
public class CommentEventId implements Serializable {
    ...
    public CommentEventId()
    {
    }

    public CommentEventId(BigInteger articleId, BigInteger commentSeqId, BigInteger version)
    {
        this.articleId = articleId;
        this.commentSeqId = commentSeqId;
        this.version = version;
    ...
    public boolean equals(Object obj)
    {
        ...
        CommentEventId other = (CommentEventId)obj;
        return true 
            && (articleId == other.articleId || (articleId != null && articleId.equals(other.articleId)))
            && (commentSeqId == other.commentSeqId || (commentSeqId != null && commentSeqId.equals(other.commentSeqId)))
    ...
    public int hashCode()
    {
        ...
        if (this.commentSeqId != null) {
            hash += 13 * this.commentSeqId.hashCode();
        }
