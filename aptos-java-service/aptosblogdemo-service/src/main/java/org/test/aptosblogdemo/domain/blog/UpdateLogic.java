...
public class UpdateLogic implements IUpdateLogic {
    ...
    @Override
    public BlogState mutate(BlogState blogState, String name, String[] articles, Boolean isEmergency, String faVault, MutationContext<BlogState, BlogState.MutableBlogState> mutationContext) {
        return null;
    }
