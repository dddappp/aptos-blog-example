...
import org.test.aptosblogdemo.specialization.NullReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.test.aptosblogdemo.*"); //add annotation mappings
