...
public class AddTagLogic implements IAddTagLogic {
    ...
    /**
     * Performs the state mutation operation of Article.AddTag command.
     ...
     */
    public ArticleState mutate(ArticleState articleState, String tag, BigInteger aptosEventVersion, BigInteger aptosEventSequenceNumber, String aptosEventType, AptosEventGuid aptosEventGuid, String status, MutationContext<ArticleState, ArticleState.MutableArticleState> mutationContext) {
