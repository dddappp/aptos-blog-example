package org.test.aptosblogdemo.specialization.hibernate;
...
public class TableIdGenerator<TCommand, TState> implements IdGenerator<Long, TCommand, TState> {
    ...
    private static final String DEFAULT_ROOT_ENTITY_NAME = "org.test.aptosblogdemo.tool.hibernate.Hello";
