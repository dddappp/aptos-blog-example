...
module aptos_blog_example::article {
    use aptos_blog_example::comment::{Self, Comment};
    use aptos_blog_example::genesis_account;
    use aptos_blog_example::pass_object;
    use aptos_framework::account;
    use aptos_framework::event;
    use aptos_std::table::{Self, Table};
    use aptos_std::table_with_length::{Self, TableWithLength};
    use std::string::String;
    friend aptos_blog_example::article_create_logic;
    friend aptos_blog_example::article_update_logic;
    friend aptos_blog_example::article_delete_logic;
    friend aptos_blog_example::article_add_comment_logic;
    friend aptos_blog_example::article_remove_comment_logic;
    friend aptos_blog_example::article_update_comment_logic;
