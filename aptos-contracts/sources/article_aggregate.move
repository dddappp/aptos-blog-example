...
module aptos_blog_example::article_aggregate {
    use aptos_blog_example::article;
    use aptos_blog_example::article_add_comment_logic;
    use aptos_blog_example::article_create_logic;
    use aptos_blog_example::article_delete_logic;
    use aptos_blog_example::article_remove_comment_logic;
    use aptos_blog_example::article_update_comment_logic;
    use aptos_blog_example::article_update_logic;
